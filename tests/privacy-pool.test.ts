...
//   it("emits events with correct mint_address for SOL transactions", async () => {
//     console.log("\n=== Testing Event Emission (SOL) ===");

//     // This test will be implemented in the next deposit test
//     // We'll capture the transaction signature and verify events after the deposit
//     console.log("✅ Event emission test will verify events in subsequent transaction tests");
//     console.log(`   Expected mint_address for SOL: ${SOL_MINT.toString()}`);
//   });
...
//     // Verify events
//     await fetchAndDisplayEvents(provider.connection, txSignature, SOL_MINT);
